...
/// WebmapItemSelf : Describes the provided style.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct WebmapItemSelf {
    /// Name of the style.
    #[serde(rename = "name")]
    pub name: String,
...
impl WebmapItemSelf {
    ...
    pub fn new(name: String, path: String, provider: String, thumbnail_url: String, self_url: String, style_url: String) -> WebmapItemSelf {
        WebmapItemSelf {
            name,
            path,
            provider,
