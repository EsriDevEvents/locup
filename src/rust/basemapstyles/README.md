# Rust API client for basemap styles
...
Put the package under your project folder in a directory named `basemapstyles` and add the following to `Cargo.toml` under `[dependencies]`:

```
basemapstyles = { path = "./basemapstyles" }
```
